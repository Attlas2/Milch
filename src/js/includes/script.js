function init(){
    ...
    document.getElementsByClassName("u_productUpgrades")[1].addEventListener("click",ev=>bauer.upgrading(5,500,1));
    document.getElementsByClassName("u_productUpgrades")[2].addEventListener("click",ev=>bauer.upgrading(10,1800,2));
    document.getElementsByClassName("u_productUpgrades")[3].addEventListener("click",ev=>milchbaum.upgrading(2,1000,3));
    document.getElementsByClassName("u_productUpgrades")[4].addEventListener("click",ev=>milchbaum.upgrading(5,2500,4));
    document.getElementsByClassName("u_productUpgrades")[5].addEventListener("click",ev=>milchbaum.upgrading(10,7500,5));
    document.getElementsByClassName("u_productUpgrades")[6].addEventListener("click",ev=>kuhweide.upgrading(2,11000,6));
    document.getElementsByClassName("u_productUpgrades")[7].addEventListener("click",ev=>kuhweide.upgrading(5,50000,7));
    document.getElementsByClassName("u_productUpgrades")[8].addEventListener("click",ev=>kuhweide.upgrading(10,120000,8));
    document.getElementsByClassName("u_productUpgrades")[9].addEventListener("click",ev=>bauernhof.upgrading(2,52000,9));
    document.getElementsByClassName("u_productUpgrades")[10].addEventListener("click",ev=>bauernhof.upgrading(5,100000,10));
    document.getElementsByClassName("u_productUpgrades")[11].addEventListener("click",ev=>bauernhof.upgrading(10,175000,11));
    document.getElementsByClassName("u_productUpgrades")[12].addEventListener("click",ev=>saugmaschine.upgrading(2,130000,12));
    document.getElementsByClassName("u_productUpgrades")[13].addEventListener("click",ev=>saugmaschine.upgrading(5,530000,13));
    document.getElementsByClassName("u_productUpgrades")[14].addEventListener("click",ev=>saugmaschine.upgrading(10,850000,14));
    document.getElementsByClassName("u_productUpgrades")[15].addEventListener("click",ev=>milchLKW.upgrading(2,800000,15));
    document.getElementsByClassName("u_productUpgrades")[16].addEventListener("click",ev=>milchLKW.upgrading(5,1800000,16));
    document.getElementsByClassName("u_productUpgrades")[17].addEventListener("click",ev=>milchLKW.upgrading(10,3300000,17));
    document.getElementsByClassName("u_productUpgrades")[18].addEventListener("click",ev=>milchfabrik.upgrading(2,2800000,18));
    document.getElementsByClassName("u_productUpgrades")[19].addEventListener("click",ev=>milchfabrik.upgrading(5,5200000,19));
    document.getElementsByClassName("u_productUpgrades")[20].addEventListener("click",ev=>milchfabrik.upgrading(10,12000000,20));
    document.getElementsByClassName("u_productUpgrades")[21].addEventListener("click",ev=>milchturm.upgrading(2,7500000,21));
    document.getElementsByClassName("u_productUpgrades")[22].addEventListener("click",ev=>milchturm.upgrading(5,14000000,22));
    document.getElementsByClassName("u_productUpgrades")[23].addEventListener("click",ev=>milchturm.upgrading(10,43000000,23));
    document.getElementsByClassName("u_productUpgrades")[24].addEventListener("click",ev=>milchmienen.upgrading(2,15000000,24));
    document.getElementsByClassName("u_productUpgrades")[25].addEventListener("click",ev=>milchmienen.upgrading(5,50000000,25));
    document.getElementsByClassName("u_productUpgrades")[26].addEventListener("click",ev=>milchmienen.upgrading(10,150000000,26));
